...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnBuscar, btnGuardar, btnActualizar, btnEliminar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                actualizarWs(txtId.getText().toString(),txtTitle.getText().toString(), txtBody.getText().toString(), txtUser.getText().toString());
            }
        });
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                eliminarWs(txtId.getText().toString());
            }
        });
    ...
    private void actualizarWs(final String id,final String title, final String body, final String userId) {
